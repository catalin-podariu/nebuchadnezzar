...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleProductNotFoundException(ProductNotFoundException exception) {
        ...
        logger.error("handleProductNotFoundException was thrown {} -- {}", exception, errorDetails.toString());
    ...
    public ResponseEntity<?> handleIllegalArgumentException(IllegalArgumentException exception) {
        ...
        logger.error("handleIllegalArgumentException was thrown {} -- {}", exception, errorDetails.toString());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorDetails);
    }

    @ExceptionHandler(NoHandlerFoundException.class)
    public ResponseEntity<?> handleNotFoundException(NoHandlerFoundException exception) {
        ExceptionDetails errorDetails = new ExceptionDetails(LocalDateTime.now(), "Endpoint not found", HttpStatus.NOT_FOUND.value());
        logger.error("handleNotFoundException was thrown {} -- {}", exception, errorDetails.toString());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorDetails);
    }
    ...
    public ResponseEntity<?> handleException(Exception exception) {
        ...
        logger.error("handleException was thrown {} -- {}", exception, errorDetails.toString());
